          ...
          >
            ...
            <div className="mt-3 grid grid-cols-3 gap-2 text-center lg:mt-6 lg:gap-4">
              ...
              <div className="rounded-xl border border-arcade-border bg-arcade-panel-light py-2 lg:rounded-2xl lg:py-5">
                ...
                <p className="mt-1 text-xs font-semibold text-foreground lg:mt-2 lg:text-lg xl:text-xl">{formatNumber(stage.rewardGold)}</p>
              ...
              <div className="rounded-xl border border-arcade-border bg-arcade-panel-light py-2 lg:rounded-2xl lg:py-5">
                ...
                <p className="mt-1 text-xs font-semibold text-foreground lg:mt-2 lg:text-lg xl:text-xl">{stage.equipmentDropChance}%</p>
            ...
            {stage.isLocked ? (
              <div className="mt-4 flex items-center justify-center gap-1.5 rounded-full bg-arcade-panel-light py-3 font-arcade text-xs uppercase text-zinc-500 lg:mt-6 lg:py-4 lg:text-sm">
                <Lock className="h-3.5 w-3.5 lg:h-4 lg:w-4" /> Clear the previous stage first
              </div>
            ) : isPlayable ? (
              <Link href={`/combat?stage=${stage.id}`} className="mt-4 block lg:mt-6" onClick={onClose}>
