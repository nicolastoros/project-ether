...
// link that used to point at "/" (register, forgot-password, every log-out button) now points
// here too, so logging out drops you back on the login form, not the landing pitch.
